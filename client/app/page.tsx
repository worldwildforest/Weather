    ...
    return (
      <div>
        <div className="flex  bg-white justify-around  p-4">
          ...
          <div className="flex items-center">
            <Link href='/register' className="bg-gradient-to-r from-blue-500 to-blue-300 text-white mx-2 px-3 py-2 rounded-xl">Sign up</Link>
            <Link href='/login' className="bg-gradient-to-r from-blue-500 to-blue-300 text-white mx-2 px-3 py-2 rounded-xl">login</Link>
          </div>
        </div>
